    ...
    >
      ...
      >
        ...
        <div className="flex-1 flex flex-col md:flex-row overflow-hidden">
          ...
          <aside className="w-full md:w-64 bg-white border-b md:border-b-0 md:border-r border-stone-200 p-3 sm:p-4 shrink-0 overflow-x-auto md:overflow-y-auto">
              ...
              {tabs.map(tab => {
                ...
                return (
                  <button
                    ...
                    className={`flex items-center justify-between px-3.5 py-2.5 rounded-2xl text-xs font-bold transition-all shrink-0 cursor-pointer ${
                      isActive
